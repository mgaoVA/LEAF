                                ...
                                if (indicatorColumn === "-1") {
                                    ...
                                    switch (currentFormat) {
                                        case 'orgchart_employee':
                                            var sheetEmp = typeof (row[indicatorColumn]) !== "undefined" && row[indicatorColumn] !== null ? row[indicatorColumn].toString().trim() : '';
                                            if (sheetEmp !== ''){
                                        ...
                                        case 'orgchart_group':
                                            ...
                                            if (indicatorColumn === "A"){ //VISN #: name
                                            ...
                                            if (indicatorColumn === "B"){ //facilities need prefix of visn or district info
                                                let prefix;
                                                let colon_index = row["A"].toString().indexOf(':');
                                                if (colon_index !== -1 ){
                                                    prefix = row["A"].slice(0, colon_index).toString() + ' - '; //visn #:  ---> visn # -
                                                } else {
                                                    prefix = row["A"].toString().replace('District', districtInfo); //name district  ---> name VBA/NCA -
                                                    prefix += ' - ';
                                                }
                                                sheetGroup = prefix + sheetGroup; //visn # - group name, OR distName - group name
                                            }
