...
//	} 
	...
	public void filterByGroup() {   
    	...
    	highlightElement.highLightElement(driver, ele);
    	ele.sendKeys("Max Automation Testing");							//was 'clinic'. Data must've been wiped out
    	waitMethods.waiter(waitMethods.w1k);
	...
	public void filterByGroupClear()  {   //
    	...
    	waitMethods.waiter(waitMethods.w500);							//REMOVE **DEBUGGING**  System.out.println("Filter cleared");
...
//	} 
	...
	//lower priority
	//Loop to show next 2-3-4 pages of history
